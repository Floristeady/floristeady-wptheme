...
if ( get_the_author_meta( 'description' ) ) : ?>
							...
							<?php echo get_avatar( get_the_author_meta( 'user_email' ), apply_filters( 'floristeady_author_bio_avatar_size', 60 ) ); ?>
							<h2><?php printf( __( 'About %s', 'floristeady' ), get_the_author() ); ?></h2>
